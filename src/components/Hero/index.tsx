  ...
  return (
    <>
      ...
      >
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Hi! I'm{" "}
                  <strong className="transition-all duration-300 hover:scale-110 hover:text-orange-500">
                    Dimas Budiriansyah
                  </strong>
                </h1>
        ...
        <div className="absolute right-0 top-0 z-[-1] h-[556px] w-[450px] opacity-30 lg:opacity-100">
          <Image
            src="/images/dimasnih.png" // Sesuaikan path gambar
            alt="Your Photo"
            width={450}
            height={556}
